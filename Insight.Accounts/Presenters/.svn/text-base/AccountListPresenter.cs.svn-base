...
namespace Insight.Accounts.Presenters
{
    public class AccountListPresenter : Presenter
    {
        ...
        {
            int count = 0;
            //_view.ResultSet = new Insight.Accounts.Services.AccountServices().
            //    GetPagedList(_view.CurrentPageIndex, _view.PageSize, out count).
            //    ToList<Account>();
            _view.ResultSet = new AccountServices().
                GetFilteredPagedList(_view.CurrentPageIndex, _view.PageSize, out count).
                ToList<Account>();
