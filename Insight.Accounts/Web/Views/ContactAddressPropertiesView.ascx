<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactAddressPropertiesView.ascx.cs" Inherits="Insight.Accounts.Web.Views.ContactAddressPropertiesView" %>
