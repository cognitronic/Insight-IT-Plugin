...
namespace Insight.Accounts.Web.Views
{
    ...
    public partial class ContactAddressPropertiesView : BaseWebUserControl, IContactAddressPropertiesView
    {
        ...
        public void LoadItem(IContactAddress t)
        {
        ...
        public Contact ContactReference
        {
            get;
            set;
        }
