...
{
    [PresenterType(typeof(AccountAddressPropertiesPresenter))]
    public partial class AccountAddressPropertiesView : BaseWebUserControl, IAccountAddressPropertiesView
    {
