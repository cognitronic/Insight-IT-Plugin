...
{
    [PresenterType(typeof(ContactEmailListPresenter))]
    public partial class ContactEmailListView : BaseWebUserControl, IContactEmailListView
    {
        ...
        #region IContactEmailListView Members
        ...
        public IList<IContactEmail> ResultSet
        {
            get;
            set;
        }
