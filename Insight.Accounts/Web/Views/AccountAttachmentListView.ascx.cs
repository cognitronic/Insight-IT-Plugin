...
{
    [PresenterType(typeof(AccountAttachmentListPresenter))]
    public partial class AccountAttachmentListView : BaseWebUserControl, IAccountAttachmentListView
    {
        ...
        public IList<AccountAttachment> ResultSet
        {
            get;
            set;
        }
